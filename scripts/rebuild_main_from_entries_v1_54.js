...
const summary = [
  '按行业扩展包逐条补充23行业笔试/面试扩展题（每行业新增12+12），并优先补缺失阶段。',
  '新增岗位家族导航与细分岗位扩容卡，补齐“核心岗/高增长岗/桥接岗”与检索回填规则。',
  '统一保留BOSS/小红书受限补录位，明确必填字段、检索入口与截图留证规则。'
];
...
// Update index order metadata if present.
