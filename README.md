...
## 本次更新要点（2026-02-19）
- 主数据升级到 `v1.47.0`，继续执行题库同权策略（official_original / real_recall / jd_mapping）。
- 新增 `reports/23行业信息缺口与检索卡_v1.47.0`（json+md），逐行业给出BOSS/小红书可达性、缺口字段、检索步骤、替代来源。
- 保留并衔接 `v1.46.0` 内容扩展包，形成“内容扩展 + 信息补录”双清单执行链路。
