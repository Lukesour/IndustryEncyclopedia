...
## 本次更新要点（2026-02-18）
- 版本升级到 `v1.37.1`，针对5个低分行业逐条新增官方题库样本（笔试+面试共10条）。
- 金融-保险新增平安校园招聘官方入口，化工与新材料新增恒力集团来源并扩充公司清单到6家。
- 延续 `v1.37.0`：政策/事件过期锚点已批量刷新为近180天官方来源，并保留薪酬口径的过渡说明。
