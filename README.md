...
## 本次更新要点（2026-02-19）
- 主数据升级到 `v1.51.0`，继续执行题库同权策略（official_original / real_recall / jd_mapping）。
- 按 `v1.48.0` 任务板完成第3批直写：新增6个行业（金融-证券基金、生物医药与器械、农业与食品、教育与职教、咨询与专业服务、能源与公用事业）扩容。
- 上述6行业均新增2个细分岗位，并逐岗位新增分阶段笔试/面试题（提前批/主批/补录/实习转正）。
